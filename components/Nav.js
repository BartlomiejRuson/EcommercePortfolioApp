...
function Nav() {
  return (
    <nav className="flex bg-black text-white items-center justify-between">
      ...
      <div className="flex space-x-10 mx-5 text-center items-center">
        ...
        <div className="absolute top-4 -right-3 bg-lightRed animate-pulse w-6 h-6 rounded-full text-center ">0</div>
        </div>
